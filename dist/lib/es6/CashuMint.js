...
var CashuMint = /** @class */ (function () {
     ...
     */
    CashuMint.mintQuote = function (mintUrl, requestMintPayload, customRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var requestInstance;
            return __generator(this, function (_a) {
                requestInstance = customRequest || request;
     ...
     * @returns the mint will create and return a Lightning invoice for the specified amount
     */
    CashuMint.prototype.mintQuote = function (requestMintPayload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, CashuMint.mintQuote(this._mintUrl, requestMintPayload, this._customRequest)];
            });
        });
    };
    /**
