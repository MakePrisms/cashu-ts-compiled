...
var CashuWallet = /** @class */ (function () {
     ...
     */
    function CashuWallet(mint, keys, mnemonicOrSeed) {
        this.unit = 'sat';
        this.mint = mint;
        if (keys) {
            this._keys = keys;
        ...
        if (!(0, bip39_1.validateMnemonic)(mnemonicOrSeed, english_1.wordlist)) {
            throw new Error('Tried to instantiate with mnemonic, but mnemonic was invalid');
        }
        this._seed = (0, secrets_js_1.deriveSeedFromMnemonic)(mnemonicOrSeed);
    }
     ...
     */
    CashuWallet.prototype.receive = function (token, preference, counter) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _c.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.receiveTokenEntry(tokenEntry, preference, counter)];
                    case 3:
     ...
     */
    CashuWallet.prototype.receiveTokenEntry = function (tokenEntry, preference, counter) {
        return __awaiter(this, void 0, void 0, function () {
            var proofsWithError, proofs, amount, keys, _a, payload, blindedMessages, _b, signatures, error, newProofs, error_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        proofsWithError = [];
                    ...
                    case 2:
                        keys = _c.sent();
                        _a = this.createSplitPayload(amount, tokenEntry.proofs, keys, preference, counter), payload = _a.payload, blindedMessages = _a.blindedMessages;
                        return [4 /*yield*/, CashuMint_js_1.CashuMint.split(tokenEntry.mint, payload)];
                    case 3:
                        _b = _c.sent(), signatures = _b.signatures, error = _b.error;
     ...
     */
    CashuWallet.prototype.send = function (amount, proofs, preference, counter) {
        return __awaiter(this, void 0, void 0, function () {
            var keyset, amountAvailable, proofsToSend, proofsToKeep, _a, amountKeep_1, amountSend, _b, payload, blindedMessages, signatures, proofs_1, splitProofsToKeep_1, splitProofsToSend_1, amountKeepCounter_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (preference) {
                    ...
                    case 1:
                        ...
                        if (!(amount < amountAvailable || preference)) return [3 /*break*/, 3];
                        _a = this.splitReceive(amount, amountAvailable), amountKeep_1 = _a.amountKeep, amountSend = _a.amountSend;
                        _b = this.createSplitPayload(amountSend, proofsToSend, keyset, preference, counter), payload = _b.payload, blindedMessages = _b.blindedMessages;
     ...
     * @returns proofs
     */
    CashuWallet.prototype.restore = function (start, count, keysetId) {
        return __awaiter(this, void 0, void 0, function () {
            var keys, amounts, _a, blindedMessages, rs, secrets, _b, outputs, promises, validRs, validSecrets;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.getKeys(keysetId)];
                    case 1:
                        keys = _c.sent();
                        if (!this._seed) {
    ...
    CashuWallet.prototype.getKeys = function (keysetId, unit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this._keys) return [3 /*break*/, 2];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.mint.mintQuote(requestMintPayload)];
     ...
     * @returns proofs
     */
    CashuWallet.prototype.mintTokens = function (amount, quote, keysetId, AmountPreference, counter) {
        return __awaiter(this, void 0, void 0, function () {
            var keyset, _a, blindedMessages, secrets, rs, postMintPayload, signatures;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getKeys(keysetId)];
                    case 1:
                        keyset = _b.sent();
                        _a = this.createRandomBlindedMessages(amount, keysetId !== null && keysetId !== void 0 ? keysetId : keyset.id, AmountPreference, counter), blindedMessages = _a.blindedMessages, secrets = _a.secrets, rs = _a.rs;
                        postMintPayload = {
                            outputs: blindedMessages,
                            quote: quote
                        };
                        return [4 /*yield*/, this.mint.mint(postMintPayload)];
                    case 2:
    ...
    CashuWallet.prototype.getMeltQuote = function (invoice) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mint.meltQuote({ unit: this.unit, request: invoice })];
                    case 1:
                        meltQuote = _a.sent();
     ...
     * @returns
     */
    CashuWallet.prototype.meltTokens = function (meltQuote, proofsToSend, keysetId, counter) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        keys = _c.sent();
                        _b = this.createBlankOutputs(meltQuote.fee_reserve, keys.id, counter), blindedMessages = _b.blindedMessages, secrets = _b.secrets, rs = _b.rs;
                        meltPayload = {
     ...
     * @returns
     */
    CashuWallet.prototype.payLnInvoice = function (invoice, proofsToSend, meltQuote, keysetId, counter) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!meltQuote) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.mint.meltQuote({ unit: this.unit, request: invoice })];
                    case 1:
                        meltQuote = _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.meltTokens(meltQuote, proofsToSend, keysetId, counter)];
     ...
     * @param counter? optionally set counter to derive secret deterministically. CashuWallet class must be initialized with seed phrase to take effect
     */
    CashuWallet.prototype.payLnInvoiceWithToken = function (invoice, token, meltQuote, keysetId, counter) {
        var _this = this;
        var decodedToken = (0, utils_js_1.getDecodedToken)(token);
     ...
     * @returns
     */
    CashuWallet.prototype.createSplitPayload = function (amount, proofsToSend, keyset, preference, counter) {
        ...
        var sendBlindedMessages = this.createRandomBlindedMessages(amount, keyset.id, preference, counter);
     ...
     */
    CashuWallet.prototype.createRandomBlindedMessages = function (amount, keysetId, amountPreference, counter) {
     ...
     * @returns blinded messages, secrets, rs, and amounts
     */
    CashuWallet.prototype.createBlindedMessages = function (amounts, keysetId, counter) {
        ...
        for (var i = 0; i < amounts.length; i++) {
            ...
            var secret = new TextEncoder().encode(secretHex);
            secrets.push(secret);
            var _a = dhke.blindMessage(secret, deterministicR), B_ = _a.B_, r = _a.r;
            rs.push(r);
