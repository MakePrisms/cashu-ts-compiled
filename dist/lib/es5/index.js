...
exports.setGlobalRequestOptions = exports.decodeInvoice = exports.deriveSeedFromMnemonic = exports.generateNewMnemonic = exports.getDecodedLnInvoice = exports.deriveKeysetId = exports.getEncodedToken = exports.getDecodedToken = exports.CashuWallet = exports.CashuMint = void 0;
...
Object.defineProperty(exports, "decodeInvoice", { enumerable: true, get: function () { return utils_js_1.decodeInvoice; } });
var bolt11_decode_1 = require("@gandlaf21/bolt11-decode");
__exportStar(require("./model/types/index.js"), exports);
/**
 * @deprecated use decodeInvoice instead
 */
var getDecodedLnInvoice = bolt11_decode_1.decode;
exports.getDecodedLnInvoice = getDecodedLnInvoice;
