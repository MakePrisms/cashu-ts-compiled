...
exports.getDefaultAmountPreference = exports.splitAmount = exports.hexToNumber = exports.getEncodedToken = exports.getDecodedToken = exports.bytesToNumber = exports.bigIntStringify = exports.decodeInvoice = exports.joinUrls = exports.checkResponse = exports.isObj = exports.sortProofsById = exports.cleanToken = exports.deriveKeysetId = void 0;
...
function deriveKeysetId(keys) {
    var pubkeysConcat = Object.entries(keys)
        ...
        .join('');
    var hash = (0, sha256_1.sha256)(new TextEncoder().encode(pubkeysConcat));
    var hashHex = (0, utils_1.bytesToHex)(hash);
...
function decodeInvoice(bolt11Invoice) {
    var invoiceData = {};
    var decodeResult = (0, bolt11_decode_1.decode)(bolt11Invoice);
